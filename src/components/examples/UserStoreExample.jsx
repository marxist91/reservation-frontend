      ...
      <Paper sx={{ p: 2, mt: 3 }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          <Alert severity="success">
            ✅ Email valide: {validateEmail('test@example.com') ? 'Oui' : 'Non'}
          </Alert>
          <Alert severity="error">
            ❌ Email invalide: {validateEmail('invalid-email') ? 'Oui' : 'Non'}
          </Alert>
          <Alert severity="info">
            Nom vide: {validateName('').valid ? '✅ Valide' : `❌ ${validateName('').message}`}
          </Alert>
        </Box>
      </Paper>
